...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Welcome to Jheel's interesting human brain facts, ask me a brain fact"
...
class BrainFactIntentHandler(AbstractRequestHandler):
    """Handler for brain fact Intent."""
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return ask_utils.is_intent_name("BrainFactIntent")(handler_input)
...
sb.add_request_handler(BrainFactIntentHandler())
